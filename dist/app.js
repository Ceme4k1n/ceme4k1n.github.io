...
function getScore() {
    var _a;
    return (_a = Number(localStorage.getItem('score'))) !== null && _a !== void 0 ? _a : 0;
}
function addOne() {
    setScore(getScore() + 1);
}
function minusProgressBar(value) {
    if ($progress) {
...
if ($circle) {
    $circle.addEventListener('click', (event) => {
        ...
        (_a = $circle.parentElement) === null || _a === void 0 ? void 0 : _a.appendChild(plusOne);
        addOne();
        minusProgressBar(10);
